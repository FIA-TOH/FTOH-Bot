...
export const AstonMaiaEngine: Engine = {
  ...
  initialAcceleration: constants.ASTON_MAIA_ENGINE_INITIAL_ACCELERATION_BOOST,
  medialAcceleration: constants.ASTON_MAIA_ENGINE_MEDIAL_ACCELERATION_BOOST,
  finalAcceleration: constants.ASTON_MAIA_ENGINE_FINAL_ACCELERATION_BOOST,
  topSpeedBoost: 0,
  confiability: 100,
};
